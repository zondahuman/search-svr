...
public class PageByFromTest {
	...
	@Test
	public void testPageByFrom() throws IOException {
        LOGGER.info("-------------start-------------");
        //查询条件
//        QueryBuilder queryBuilder = QueryBuilders.matchPhraseQuery("name", "银花");
        ...
        List<Medicine> medicineList = elasticSearchService.pageByFrom(queryBuilder, indexName, type, 1, 10);
